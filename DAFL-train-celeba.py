...
# set up data
opt.data_CelebA_train = "../../Dataset/CelebA/Img/train/"
  ...
  for step in range(opt.num_iter_per_epoch):
    ...
    while gi < opt.n_G_update:
      ...
      for attr in range(num_attributes):
        ...
        loss_information_entropy = F.kl_div(expect_dist.log(), actual_dist) * opt.num_class * math.log10(math.e)
        loss_G += loss_information_entropy * opt.ie
        
      # cos loss
      update_coslw_cond = epoch >= 1
